                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                   ...
                                   <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'cases' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('cases')}>
                                    <div className="flex items-center">
                                        <IconMenuDashboard
                                         className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('New Cases')}</span>
                                    </div>

                                    <div className={currentMenu !== 'cases' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'cases' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/allcases">{t('all cases')}</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <NavLink to="/closedcases">{t('closed')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
